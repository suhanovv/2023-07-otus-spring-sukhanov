...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public Book get(String id) throws BookNotFoundException {
    ...
    @Transactional
    @Override
    public void remove(String id) throws BookNotFoundException, BookAlreadyUsedException {
        var book = get(id);
        var commentsCount = commentRepository.countByBook(book);

        if (commentsCount > 0) {
            throw new BookAlreadyUsedException("Book id: " + id + " can't be delete");
        }
