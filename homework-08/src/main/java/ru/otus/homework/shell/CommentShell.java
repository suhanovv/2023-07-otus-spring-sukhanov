...
public class CommentShell {
    ...
    public String showComment(@ShellOption String id) {
        try {
    ...
    public String createComment(@ShellOption String bookId, @ShellOption String comment) {
    ...
    public String removeComment(@ShellOption String id) {
        try {
